                ...
                <tr>
                    <td>
                        <div class="nano_padding">
                            <div class="nano_h1">Password Recovery</div>
                            <div class="nano_p">Hey! <br><br>
                                We received a request to reset your password for your Lockity account. Please click the button below to recover your password.
                            </div>
                            <div class="nano_flex">
                                <a href="{{ route('reset.password.view', $token) }}" class="nano_button" target="_blank">Recover Password</a>
                            </div>
                        </div>
                    </td>
                </tr>
