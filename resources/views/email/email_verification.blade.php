...
<head>
    ...
    <title>Lockity - Verification Email</title>
                ...
                <tr>
                    <td>
                        <div class="nano_padding">
                            ...
                            <div class="nano_p">Welcome to Lockity! Please verify your email address to activate your account and start using our secure locker services. 
                                Click the button below to complete your verification.</div>
                            <div class="nano_flex">
                                <a href="{{ $url }}" class="nano_button" target="_blank">Verify email</a>
                            </div>
                            <div class="nano_p">This link will expire in 60 minutes.</div>
                        </div>
                    </td>
                </tr>
